...
<body>
    ...
    <div id="content">
        ...
        <%
            ...
            id = consulta("IDAVION")
            modelo = consulta("AVION")
            n_plazas = consulta("N_PLAZAS")
            precio = consulta("PRECIO_BASE")
        %>

        <form name="formulario_1" action="actualizar_avion_formulario.asp" method="post">
            <table>
                <tr>
                    <td>ID AVION:</td>
                    <td><input type="text" name="idavion" readonly value='<%= id %>'></td>
                </tr>
                <tr>
                    <td>MODELO AVION:</td>
                    <td><input type="text" name="avion" value='<%= modelo %>'></td>
                </tr>
                <tr>
                    <td>NUMERO DE PLAZAS:</td>
                    <td><input type="text" name="n_plazas" value="<%= n_plazas %>"></td>
                </tr>
                <tr>
                    <td>PRECIO BASE:</td>
                    <td><input type="text" name="precio_base" value="<%= precio %>"></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <center><input type="submit" name="actualizar_avion" value="Actualizar"></center>
                    </td>
                </tr>
            </table>
        </form>
